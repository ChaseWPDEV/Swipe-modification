...
console.log("Hacked Flip Loaded");
{ /* Main */
    (function init(jQuery, window, document, undefined) {
        ...
        var ui_6 = {
            ...
            backgroundColor:"#EEE",
            sideBtnColor:"#000",
            sideBtnBackground:"#FFFFFF99",
            menuBackground:'#FFFFFF99',
            icons:'material',
            menuFloating:true,
            sideBtnSize:40
        }
        ...
        if(options.theme === 6)
            options = jQuery.extend(true, {}, ui_6, options);

        var ui_7 = {
            skinColor:"#DDD",
            skinBackground:"#151515",
            zoomMin:1,
            backgroundColor:"#212121",
            menuBackground:'#151515',
            // menuTransparent:1,
            sideBtnColor:"#CCC",
            sideBtnBackground:"#15151599",
            floatingBtnColor:"#CCC",
            floatingBtnBackground:"#15151599",
            currentPage:{vAlign:'bottom', hAlign:'center',order:1},
            btnAutoplay:{hAlign:'left'},
            btnSound:{hAlign:'left'},
            btnExpand:{hAlign:'right'},
            btnZoomIn:{hAlign:'right'},
            btnZoomOut:{hAlign:'right'},
            btnSearch:{hAlign:'left', vAlign:''},
            btnBookmark:{hAlign:'left', vAlign:''},
            btnToc:{hAlign:'left', vAlign:''},
            btnThumbs:{hAlign:'left', vAlign:''},
            btnShare:{hAlign:'right', vAlign:''},
            btnPrint:{hAlign:'right', vAlign:''},
            btnDownloadPages:{hAlign:'right', vAlign:''},
            btnDownloadPdf:{hAlign:'right', vAlign:''},
            btnSelect:{hAlign:'right', vAlign:''},
            icons:'material',
            sideBtnSize:40
        }

        if(options.theme === 7)
            options = jQuery.extend(true, {}, ui_7, options);
            ...
            else if(!jQuery('.flipbook-preloader').length)
        ...
        FLIPBOOK.Main.prototype = {
            ...
            updateSkinColors:function(){
                ...
                if(o.skinColor)
                    jQuery('.skin-color').css('color', o.skinColor)
                if(o.skinBackground)
                    jQuery('.skin-color-bg').css('background', o.skinBackground)
